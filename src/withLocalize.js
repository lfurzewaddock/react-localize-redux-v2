...
const mapStateToProps = (
  slice: ?string,
  getStateSlice: ?GetSliceStateFn
): MapStateToProps<LocaleState, {}, LocalizeStateProps> => (
  state: Object | LocaleState
): LocalizeStateProps => {
...
export const withLocalize = (
  Component: ComponentType<any>,
  slice: ?string = null,
  getStateSlice: ?GetSliceStateFn = null
) => connect(mapStateToProps(slice, getStateSlice))(Component);
