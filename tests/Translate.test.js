...
describe("<Translate />", () => {
  ...
  it("should throw an error if redux store not found", () => {
    expect(() => shallow(<Translate id="hi">Hi</Translate>)).toThrowError();
  });
  ...
  it("should use context.getLocaleState to get locale state from store", () => {
    ...
    expect(() =>
      shallow(<Translate id="nope">Hey</Translate>, {
    ...
    expect(() =>
      shallow(<Translate id="nope">Hey</Translate>, {
        context: {
          ...
          getLocaleState: state => state.nope
        }
      })
    ).toThrowError();
  });
  ...
  it("should render HTML in translations", () => {
    const wrapper = getComponent(
      <Translate id="hi" options={{ defaultLanguage: "fr" }}>
        Hey <a href="http://google.com">google</a>
      </Translate>,
      {
        ...initialState,
  ...
  it("should override renderInnerHtml option for <Translate/>", () => {
    const wrapper = getComponent(
      <Translate id="hi" options={{ renderInnerHtml: false }}>
        Hi <strong>Ted</strong>!
      </Translate>
    );
  ...
  it("should override missingTranslationMsg option for <Translate/>", () => {
    ...
    const wrapper = getComponent(
      <Translate id="nope" options={options}>
        Hey
      </Translate>
    );
  ...
  it("should allow for passing a custom function to return state slice", () => {
    const immutableStore = mockStore(
      Map({
        locale: {
          ...initialState,
          translations: {
    ...
    expect(() =>
      shallow(<Translate id="hi">Hey</Translate>, {
