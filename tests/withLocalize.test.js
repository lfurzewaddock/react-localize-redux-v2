...
import { localize } from "../src"; // Deprecated - replaced by withLocalize
...
describe("<withLocalize />", () => {
  ...
  beforeEach(() => {
    ...
    WrappedComponent = withLocalize(MockPageComponent);
  ...
  it("should use state including slice when passed", () => {
    ...
    WrappedComponent = withLocalize(MockPageComponent, "locale");
    wrapper = shallow(<WrappedComponent />, { context: { store } });
  ...
  it("should allow for passing a custom function to return state slice", () => {
    ...
    WrappedComponent = withLocalize(MockPageComponent, "locale", getStateSlice);
    wrapper = shallow(<WrappedComponent />, { context: { store } });
    expect(wrapper.props().translate).toBeDefined();
    expect(wrapper.props().translate("hi")).toEqual("hello");
  });
...
describe("<withLocalize /> unhappy path", function() {
  const mockStore = configureStore();
  ...
  it("should return currentLanguage = undefined when no active language set", () => {
    ...
    const WrappedComponent = withLocalize(MockPageComponent, "locale");
